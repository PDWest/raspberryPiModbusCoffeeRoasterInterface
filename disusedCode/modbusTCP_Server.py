...
# PWM = nodeLynkDevs('PWM')
TempHum = nodeLynkDevs('TempHum')
#gasPressure = nodeLynkDevs('gasPressure')
...
#print("t1 = ",TC_1.read_temp_f()," t2= ",TC_2.read_temp_f())
...
def read_data_store(slave_id, function_code, address):
    ...
    if address == 1:
        print(" TC = 1")
        print("returning TC1=",TC_1.read_temp_f_4_Artisan())
        return TC_1.read_temp_f_4_Artisan()
    elif address == 2:
       
        print(" TC = 2")
        print("returning TC2=",TC_2.read_temp_f_4_Artisan())
        return TC_2.read_temp_f_4_Artisan()
    elif address == 3:
        print("PWM return value =", PWM.readPWM())
        return PWM.readPWM()
